...
from nest.topology.interface.wireless_interface import leave_wireless_network, start_adhoc_network
...
class TestWirelessNetworks(unittest.TestCase):
    ...
    def test_ibss_network_group_join(self):
        [wlan1, wlan2, wlan3] = start_adhoc_network([self.sta1, self.sta2, self.sta3], "test_ibss2")
    ...
    def test_ibss_wireless_topology_map(self):
        ...
        self.assertEqual(len(WirelessTopologyMap.wireless_topology_map['ibss'][0]['stations']), 3)

        self.sta1.leave_wireless_network()
        self.assertEqual(len(WirelessTopologyMap.wireless_topology_map['ibss'][0]['stations']), 2)
    ...
    def test_bss_wireless_topology_map(self):
        ...
        self.assertEqual(WirelessTopologyMap.wireless_topology_map['bss'][0]['ssid'], 'bss1')
        self.assertEqual(len(WirelessTopologyMap.wireless_topology_map['bss'][0]['stations']), 2)

        self.sta1.leave_wireless_network()
        self.assertEqual(len(WirelessTopologyMap.wireless_topology_map['bss'][0]['stations']), 1)
